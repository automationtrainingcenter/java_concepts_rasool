...
public class VariablesDemo {
	...
	public void insMethod() {
		System.out.println("instance variable inside insMethod "+iVar);
		System.out.println("static variable inside insMethod "+sVar);
	}
	...
	public static void main(String[] args) {
		...
		//create an object to access instance varaible
