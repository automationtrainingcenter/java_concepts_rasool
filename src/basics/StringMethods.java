...
public class StringMethods {
	public static void main(String[] args) {
		...
		String s3 = " webdriver";
		String s4 = "VASU";
		String s5 = "welcome to the selenium course with Java Java programming launguage";
		String s6 = "                          actual text                          ";
		/*
		 * length() : which will return an integer value which is the number of
		 * characters in the given string
		 */
		System.out.println("number of letter in s1 is "+s1.length());
		...
		System.out.println(s4.equals("vasu"));
		...
		System.out.println(s4.equalsIgnoreCase("vasu"));
